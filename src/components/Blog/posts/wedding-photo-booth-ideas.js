export const post = {
  ...
  <h2>3. Add Fun Props and Lighting</h2>
  <p>From heart glasses to floral crowns, props create laughter and natural poses. We also include ring lights for perfect lighting every time!</p>

  <h2>4. Offer a Guestbook Station</h2>
  <p>Let guests paste a photo strip and write a short message — a keepsake you’ll treasure forever.</p>
