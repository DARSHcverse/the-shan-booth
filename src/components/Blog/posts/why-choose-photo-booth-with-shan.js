...
export const post = {
  ...
  keywords: [
    ...
    "photo booth packages melbourne"
  ],
  content: `
  <p>Looking for the <strong>best photo booth hire in Melbourne</strong>? At <strong>Photo Booth With Shan</strong>, we make your event unforgettable with stylish setups, high-quality photos, and friendly service designed to capture every laugh and memory.</p>

  <h2>🎉 1. Affordable Photo Booth Packages</h2>
  <p>We offer flexible <a href="/packages">photo booth hire packages</a> to suit every event and budget — from weddings and birthdays to corporate functions. Every package includes <strong>unlimited photos</strong>, <strong>instant prints</strong>, and a <strong>professional booth attendant</strong>.</p>
  <ul>
    <li>Standard Booths — starting from $390 for 2 hours</li>
    <li>Glam Booths — starting from $490 for 2 hours</li>
    <li>Custom add-ons and upgrades available</li>
  </ul>
  ...
  <p>When you choose <strong>Photo Booth With Shan</strong>, you’re choosing <strong>affordable prices, premium service, and unforgettable experiences</strong>. Let us make your next event shine with our <a href="/packages">photo booth hire packages</a> and <a href="${QUICK_QUOTE_URL}">instant quotes</a>.</p>
  ...
  <p>Ready to experience the difference? Browse our <a href="/packages">complete package options</a> or <a href="${QUICK_QUOTE_URL}">get an instant quote</a> for your upcoming event. We proudly serve <strong>Melbourne, Geelong, and regional Victoria</strong> with reliable, professional photo booth services.</p>
  `,
};
