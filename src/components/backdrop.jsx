...
const blackdrop = '/images/blackbackdrop.png';
const graddrop = '/images/gradbackdrop.png';
const whitedrop = '/images/whitebackdrop.png';
const flowerkdrop = '/images/flowerbackdrop.png';
...
const backdropImages = [
  {
    ...
    description: "Sleek black backdrop suitable for weddings and formal events.",
  },
  {
    id: "b2",
    src: whitedrop,
    title: "White Backdrop",
    description: "Classic white backdrop perfect for modern, clean photo setups.",
  },
  {
    id: "b3",
    src: graddrop,
    title: "Graduation Backdrop",
    description: "Celebrate milestones with a themed graduation backdrop.",
  },
  {
    id: "b4",
    src: flowerkdrop,
    title: "Floral Backdrop",
    description: "Bright and playful floral backdrop for weddings and parties.",
  },
];
          ...
          <div className="interactive-floating-area">
            {backdropImages.map((backdrop) => (
              ...
              >
                ...
                <p className="backdrop-card-description">
        ...
        {isModalOpen && selectedBackdrop && (
          ...
          >
            ...
            >
              ...
              <h3 className="backdrop-modal-title">
                {selectedBackdrop.title}
              </h3>
              <img
